...
HELP_TEXT = (
    "🤖 <b>Как играть через бота</b>\n\n"

    "<b>Шаг 1 — Регистрация (один раз)</b>\n"
    "Каждый игрок должен написать боту в личку:\n"
    "<code>/start</code>\n"
    "Это нужно, чтобы бот мог отправить тебе роль и голосование по миссии.\n\n"

    "<b>Шаг 2 — Создать игру в группе</b>\n"
    "Один из игроков пишет в групповой чат:\n"
    "<code>/newgame</code>\n"
    "Появится сообщение с кнопкой «Вступить в игру».\n\n"

    "<b>Шаг 3 — Все вступают</b>\n"
    "Каждый игрок нажимает кнопку <b>«Вступить в игру»</b> в группе.\n"
    "Нужно от 5 до 10 игроков.\n\n"

    "<b>Шаг 4 — Старт</b>\n"
    "Когда все собрались, хост нажимает <b>«Начать игру»</b>.\n"
    "Бот отправит каждому роль в личку.\n\n"

    "<b>Шаг 5 — Игровой процесс</b>\n"
    "• <b>Лидер</b> выбирает команду для миссии — нажимает на имена в группе\n"
    "• Все игроки голосуют <b>«За»</b> или <b>«Против»</b> прямо в чате\n"
    "• Если команда одобрена — её участники получают голосование в <b>личку</b>\n"
    "• Результат объявляется в группе\n\n"

    "<b>Команды</b>\n"
    "/newgame — начать новую игру (в группе)\n"
    "/rules — правила игры\n"
    "/help — это сообщение\n"
    "/endgame — досрочно завершить игру (только хост)\n\n"

    "❓ Если бот не отвечает на личное сообщение — убедись, что написал ему <code>/start</code> в ЛС."
)
